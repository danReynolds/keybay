...
set, the first run reports it missing before npm starts. Enter a disposable
value at the hidden prompt. The app then listens only on
`http://127.0.0.1:4242`. Open that URL in a browser to see the exact value
inherited by the Node process.
